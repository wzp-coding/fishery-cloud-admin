<template>
  <div>
    <el-dialog
      ...
      @close="close"
    >
      <el-form ref="form" :model="stationobject" label-width="80px">
        <el-form-item label="站点类型">
          <el-select
            v-model="stationobject.logisticsStationType"
            placeholder="请选择站点类型"
          >
        ...
        <el-form-item label="站点地址">
          <el-select
            v-model="stationobject.logisticsStationAddress"
            placeholder="请选择站点地址"
            style="width: 50ex"
          >
            <el-option
...
export default {
  ...
  methods: {
    ...
    async customerinfo() {
      ...
      const { data: res } = await this.$logistics.post(
        "station/",
        this.stationobject
      );
      console.log("res: ", res);
